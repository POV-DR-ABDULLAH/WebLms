...
const TestimonialSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className="md:text-base text-gray-500 mt-3">Discover the impact of our courses on real learners. Read their testimonials and see how our platform  <br /> is helping people achieve their goals.</p>
