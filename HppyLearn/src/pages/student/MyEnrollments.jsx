  ...
  return (
    ...
    <div className='md:px-36 px-8 pt-10'>
      ...
      <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'>
        <thead className="text-gray-900 border-b border-gray-400/20 text-sm text-left max-sm:hidden">
          <tr className=''>
            ...
            <tr className="border-b border-gray-500/20" key={index}>
              <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <Line percent={progressArray[index] && progressArray[index].lectureCompleted / progressArray[index].totalLecture * 100} strokeWidth={2} trailColor="#D3D3D3" strokeColor="#000" />
                </div>
              </td>
